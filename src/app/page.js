    ...
    return (
      ...
      <Navbar fluid className="bg-cyan-400">
        ...
        <NavbarBrand as={Link} href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">
          <Image src="https://www.yuntech.edu.tw/images/website_png/Group_638.png" width={200} height={200} className="mr-3 h-6 sm:h-9" alt="Flowbite React Logo" />
      ...
      <div className="h-56 sm:h-64 xl:h-80 2xl:h-96">
        <Carousel>
          <Image src="/banner/ban-1.jpg" width={200} height={200} alt="copyright of kim huynh" />
          <Image src="/banner/ban-2.jpg" width={200} height={200} alt="copyright of Kenneth Lu" />
          <Image src="/banner/ban-3.jpg" width={200} height={200} alt="copyright of Quinn Dombrowski" />
          <Image src="/banner/ban-4.jpg" width={200} height={200} alt="copyright  of Quinn Dombrowski" />
          <Image src="https://flowbite.com/docs/images/carousel/carousel-5.svg" width={200} height={200} alt="..." />
        </Carousel>
      </div>
